...
# we use set_main_option to override sqlalchemy.url in alembic.ini module, than set the credential here
#why have we done this? To 
# prevent exposing sensetive information. Also hardcoding will break in there env, example like right now is on local host
